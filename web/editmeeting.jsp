...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <form class="layui-form" action="/frontdemo_war_exploded/doeditmeeting" method="post">
            <fieldset>
                <legend>会议信息</legend>
                <table class="layui-table">
                    <tr>
                        ...
                        <td>会议名称：</td>
                        <td>
                            <input value="${m.meetingname}" class="layui-input" type="text" id="meetingname" name="meetingname" maxlength="20"/>
                        </td>
                    </tr>
                    <tr>
                        <td>预计参加人数：</td>
                        <td>
                            <input value="${m.numberofparticipants}" class="layui-input" type="text" id="numofattendents" name="numberofparticipants"/>
                        </td>
                    </tr>
                    <tr>
                        <td>预计开始时间：</td>
                        <td>
                            <input value="${m.starttime}" class="Wdate" type="text" id="starttime" name="starttime"
                    ...
                    <tr>
                        <td>预计结束时间：</td>
                        <td>
                            <input value="${m.endtime}"  class="Wdate" type="text" id="endtime" name="endtime"
                                   onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
                        </td>
                    </tr>
                    <tr>
